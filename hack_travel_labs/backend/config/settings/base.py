"""
Base settings for hack_travel_labs project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'hack_travel_labs.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'hack_travel_labs.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'hack_travel_labs.users.adapters.SocialAccountAdapter'
...
# INSTALLED_APPS += ['hack_travel_labs.taskapp.celery.CeleryConfig']
...
FRAMES_ROOT = os.path.join(MEDIA_ROOT, 'frames')
FRAMES_PER_VIDEO = 250
FRAMES_FILENAME_LENGTH = 3
SECONDS_PER_PART = 30

BANNERS_ROOT = os.path.join(MEDIA_ROOT, 'banners')
